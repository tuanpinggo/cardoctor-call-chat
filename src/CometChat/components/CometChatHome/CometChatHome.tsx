...
import { UploadFileContractResult } from '../CometChatMessages/interface';
...
function CometChatHome({ defaultUser, defaultGroup, handleUpload, titleView, enableUploadContract = false }: CometChatHomeProps) {
    ...
    const attachSDKGroupListenerForDetails = () => {
      ...
      CometChat.addGroupListener(
        ...
        new CometChat.GroupListener({
          ...
          onGroupMemberLeft: (_message: CometChat.Action, _leavingUser: CometChat.User, group: CometChat.Group) => {
  ...
  const SideComponentGroup = React.memo((props: { group: CometChat.Group }) => {
    ...
    const [_groupOwner, setGroupOwner] = useState(group.getOwner());
