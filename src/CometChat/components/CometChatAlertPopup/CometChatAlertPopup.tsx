      ...
      <div className="cometchat-alert-popup-wrapper">
        <div className="cometchat-alert-popup">
          ...
          <div className="cometchat-alert-popup__text">
            <div className="cometchat-alert-popup__text-title">{title}</div>
            <div className="cometchat-alert-popup__text-subtitle">{description}</div>
          </div>

          <div className="cometchat-alert-popup__button-wrapper">
            <CometChatButton text={getLocalizedString('understood')} onClick={onConfirmClick} />
          </div>
        </div>
      </div>
    </div>
